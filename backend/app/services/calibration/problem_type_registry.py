...
PROBLEM_TYPE_REGISTRY: Dict[str, Dict[str, PriorConfig]] = {
    ...
    "vehicle-comparison-lab": {
        "metric_leader":      PriorConfig(2.5, "Read one metric and identify the leading vehicle"),
        "evidence_choice":     PriorConfig(3.0, "Choose a vehicle and cite the supporting metric"),
        "constraint_tradeoff": PriorConfig(5.0, "Filter by constraints and justify a priority trade-off"),
    },
    ...
    "cell-builder": {
        "cell_inventory":      PriorConfig(2.5, "Discriminate structures that belong in a target cell"),
        "organelle_placement": PriorConfig(3.5, "Place organelles in best-fit model regions"),
        "structure_function":  PriorConfig(5.0, "Map organelles to scientific functions"),
        "cell_specialization": PriorConfig(6.5, "Tune organelle abundance for a specialized cell mission"),
    },
