...
baseline). Next pull = BACKLOG item 1 (containment `in` / `between`, flagged against
contract R11); reader-fit is PARKED with a drained queue; DI/voice
lane: **author the next development item with the user**; one ~45-min mic
