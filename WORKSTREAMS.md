...
lane: **item 11 AUTHORED 2026-08-05 late (user-pulled) — lesson-tutor
curiosity-question deflection + resume continuity, from the first real-child
mixed-lesson drives; machine-gated (`lesson-curiosity` journey must FAIL
pre-fix), user re-drive = #64 acceptance**; one ~45-min mic
...
- **Item 11 OPENED 2026-08-05 late (user-pulled — the "author the next development
  item with the user" pull, satisfied): lesson-mode session tutor — the script
  outranks the student, + resume continuity.** The user's son drove two real
