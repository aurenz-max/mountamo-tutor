...
export const DIAGNOSIS_SCENARIOS: DiagnosisScenario[] = [
  ...
  // ── counting-board (consumer architecture) — /misconception-test 2026-09-14 ──
  // Built by driving the SHIPPED evidence builder (countingBoardDiagnosisEvidence,
  // countingObservation) with synthetic wrong-rule journeys, not hand-typed prose.
  {
    id: 'counting-board-take-away-states-start',
    label: 'Take-away — reports the STARTING count (matches the shipped contrast move)',
    subject: 'Math',
    ...
    evidence: {
      ...
      challengeSummary: 'Counting board (take_away), 3 boards: each board starts with some objects, the tutor says how many to take away, the learner removes them and says how many are left. A wrong answer gets the tutor\'s scripted correction and the same question again, up to two corrections per board. 0 of 3 boards were answered right the first time.',
      expected: 'The number left on the board: the start minus the number taken away.',
      observed: '7 bears on the board; the tutor said to take away 2. Say how many are left. Said "7". | 9 bears on the board; the tutor said to take away 3. Say how many are left. Said "9". | 6 bears on the board; the tutor said to take away 1. Say how many are left. Said "6".',
      phases: [
        { itemId: 'ta1e', phase: 'unspecified', challenge: '7 bears on the board; the tutor said to take away 2. Say how many are left.', expected: 'five (5) left', observed: 'Said "7".', support: 'Assistance history unknown' },
        { itemId: 'ta2e', phase: 'unspecified', challenge: '9 bears on the board; the tutor said to take away 3. Say how many are left.', expected: 'six (6) left', observed: 'Said "9".', support: 'Assistance history unknown' },
        { itemId: 'ta3e', phase: 'unspecified', challenge: '6 bears on the board; the tutor said to take away 1. Say how many are left.', expected: 'five (5) left', observed: 'Said "6".', support: 'Assistance history unknown' },
      ],
    },
    expectation: 'generative',
    note: 'Reliable "reports the pre-change count" pattern. This is the signature the shipped countingBoardRemediation move (contrast_same_start_different_change) actually targets — verified in Probe G (4/4 TARGETED draws). The distiller must predict "states the starting amount", never a target number.',
  },
  {
    id: 'counting-board-take-away-states-change',
    label: 'Take-away — reports the amount REMOVED, not what is left (off-target for the shipped move)',
    subject: 'Math',
    subskillId: 'COUNT001-02-E',
    evalMode: 'take_away',
    gradeLevel: 'K',
    ...
    evidence: {
      ...
      challengeSummary: 'Counting board (take_away), 3 boards: each board starts with some objects, the tutor says how many to take away, the learner removes them and says how many are left. A wrong answer gets the tutor\'s scripted correction and the same question again, up to two corrections per board. 0 of 3 boards were answered right the first time.',
      expected: 'The number left on the board: the start minus the number taken away.',
      observed: '7 bears on the board; the tutor said to take away 2. Say how many are left. Said "2". | 9 bears on the board; the tutor said to take away 3. Say how many are left. Said "3". | 6 bears on the board; the tutor said to take away 1. Say how many are left. Said "1".',
      phases: [
        { itemId: 'ta1', phase: 'unspecified', challenge: '7 bears on the board; the tutor said to take away 2. Say how many are left.', expected: 'five (5) left', observed: 'Said "2".', support: 'Assistance history unknown' },
        { itemId: 'ta2', phase: 'unspecified', challenge: '9 bears on the board; the tutor said to take away 3. Say how many are left.', expected: 'six (6) left', observed: 'Said "3".', support: 'Assistance history unknown' },
        { itemId: 'ta3', phase: 'unspecified', challenge: '6 bears on the board; the tutor said to take away 1. Say how many are left.', expected: 'five (5) left', observed: 'Said "1".', support: 'Assistance history unknown' },
      ],
    },
    expectation: 'generative',
    note: 'A DIFFERENT reliable wrong rule than the sibling scenario above (echoes changeBy, not count). Kept deliberately as a same-primitive semantic negative control for Probe G: the shipped move must NOT fire on this diagnosis (verified — 0/2 fired). Distinguishes semantic applicability judgment from keyword/mode matching.',
  },
  {
    id: 'counting-board-count-on-says-start-back',
    label: 'Count-on — repeats the hidden STARTING quantity instead of counting on (matches the shipped move)',
    subject: 'Math',
    ...
    evidence: {
      firstResponseScore: 0,
      challengeSummary: 'Counting board (count_on), 3 boards: the tutor says how many are already in a group and the learner counts on the rest and says how many altogether. A wrong answer gets the tutor\'s scripted correction and the same question again, up to two corrections per board. 0 of 3 boards were answered right the first time.',
      expected: 'The number altogether: the start plus the objects counted on.',
      observed: 'The tutor said 5 are already in the group (visible and marked counted); 3 more bears are on the board to count on. Say how many altogether. Said "5". | The tutor said 4 are already in the group (visible and marked counted); 3 more bears are on the board to count on. Say how many altogether. Said "4". | The tutor said 6 are already in the group (visible and marked counted); 3 more bears are on the board to count on. Say how many altogether. Said "6".',
      phases: [
        { itemId: 'co1f', phase: 'unspecified', challenge: 'The tutor said 5 are already in the group (visible and marked counted); 3 more bears are on the board to count on. Say how many altogether.', expected: 'eight (8)', observed: 'Said "5".', support: 'Assistance history unknown' },
        { itemId: 'co2f', phase: 'unspecified', challenge: 'The tutor said 4 are already in the group (visible and marked counted); 3 more bears are on the board to count on. Say how many altogether.', expected: 'seven (7)', observed: 'Said "4".', support: 'Assistance history unknown' },
        { itemId: 'co3f', phase: 'unspecified', challenge: 'The tutor said 6 are already in the group (visible and marked counted); 3 more bears are on the board to count on. Say how many altogether.', expected: 'nine (9)', observed: 'Said "6".', support: 'Assistance history unknown' },
      ],
    },
    expectation: 'generative',
    note: 'Matches the shipped countingBoardRemediation move (count_on_exactly_one_more) — verified in Probe G (5/6 TARGETED across two runs; one planner-abstain draw, LLM variance).',
  },
  {
    id: 'counting-board-recount-moved-conservation',
    label: 'Recount-moved — treats rearrangement as a cue to keep counting (conservation gap, no shipped move)',
    subject: 'Math',
    ...
    evidence: {
      firstResponseScore: 0,
      challengeSummary: 'Counting board (recount_moved), 3 boards: the learner counts the objects on each board and says how many. A wrong answer gets the tutor\'s scripted correction and the same question again, up to two corrections per board. 0 of 3 boards were answered right the first time.',
      expected: 'The same number that was counted before the objects moved.',
      observed: '5 bears in a line; after the learner counted them they moved to new places and could not be touched again. Say how many now. Said "6". | 7 bears in a line; after the learner counted them they moved to new places and could not be touched again. Say how many now. Said "8". | 4 bears in a line; after the learner counted them they moved to new places and could not be touched again. Say how many now. Said "5".',
      phases: [
        { itemId: 'rm1', phase: 'unspecified', challenge: '5 bears in a line; after the learner counted them they moved to new places and could not be touched again. Say how many now.', expected: 'five (5)', observed: 'Said "6".', support: 'Assistance history unknown' },
        { itemId: 'rm2', phase: 'unspecified', challenge: '7 bears in a line; after the learner counted them they moved to new places and could not be touched again. Say how many now.', expected: 'seven (7)', observed: 'Said "8".', support: 'Assistance history unknown' },
        { itemId: 'rm3', phase: 'unspecified', challenge: '4 bears in a line; after the learner counted them they moved to new places and could not be touched again. Say how many now.', expected: 'four (4)', observed: 'Said "5".', support: 'Assistance history unknown' },
      ],
    },
    expectation: 'generative',
    note: 'recount_moved has NO countingBoardRemediation capability (per the build report: "the move is always a scatter; only the size varies", capture-only). Diagnosis should still generate honestly — the distiller knows no remediation vocabulary — but a real-engine planner correctly abstains for this mode regardless of observation (no TeachingCapability at all).',
  },
  {
    id: 'counting-board-add-more-inconsistent',
    label: 'Add-more — no stable error rule across boards, one slip unreliable',
    subject: 'Math',
    ...
    evidence: {
      firstResponseScore: 0,
      challengeSummary: 'Counting board (add_more), 3 boards: each board starts with some objects, the tutor says how many more to put on, the learner puts them on and says how many altogether. A wrong answer gets the tutor\'s scripted correction and the same question again, up to two corrections per board. 0 of 3 boards were answered right the first time.',
      expected: 'The number on the board altogether: the start plus the number put on.',
      observed: '4 bears on the board; the tutor said to put 2 more on. Say how many altogether. Said "7". | 5 bears on the board; the tutor said to put 3 more on. Say how many altogether. Said "6". | 3 bears on the board; the tutor said to put 1 more on. Say how many altogether. No reliable transcript; the tutor judged the spoken answer wrong.',
      phases: [
        { itemId: 'am1', phase: 'unspecified', challenge: '4 bears on the board; the tutor said to put 2 more on. Say how many altogether.', expected: 'six (6) altogether', observed: 'Said "7".', support: 'Assistance history unknown' },
        { itemId: 'am2', phase: 'unspecified', challenge: '5 bears on the board; the tutor said to put 3 more on. Say how many altogether.', expected: 'eight (8) altogether', observed: 'Said "6".', support: 'Assistance history unknown' },
        { itemId: 'am3', phase: 'unspecified', challenge: '3 bears on the board; the tutor said to put 1 more on. Say how many altogether.', expected: 'four (4) altogether', observed: 'No reliable transcript; the tutor judged the spoken answer wrong.', support: 'Assistance history unknown' },
      ],
      judgeFeedback: 'My turn: I put two more bears on and counted them all — one, two, three, four, five, six. Your turn. How many altogether?',
    },
    expectation: 'abstain',
    note: 'One over, one under, one unreliable transcript — no consistent wrong rule. Must abstain (verified 3/3 draws). Tier-A packet: carries judgeFeedback for the DI sentinel-script path.',
  },
];
