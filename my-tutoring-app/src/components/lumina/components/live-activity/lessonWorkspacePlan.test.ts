...
describe('ordinary lesson workspace eligibility', () => {
  ...
  it('every family that binds the workspace admits every one of its modes; no mode is withheld from lessons', () => {
    ...
    expect(bound.map(([id]) => id).sort()).toEqual(['3d-shape-explorer', 'adaptation-investigator', 'addition-subtraction-scene', 'balance-scale', 'bar-model', 'base-ten-blocks', 'calendar-explorer', 'compare-objects',
      ...
      'di-word-reading', 'fraction-circles', 'habitat-diorama', 'interactive-book', 'letter-sound-link', 'letter-spotter', 'number-bond', 'number-line', 'number-sequencer', 'number-tracer', 'ordinal-line', 'phoneme-explorer',
      'phonics-blender', 'picture-vocabulary', 'place-value-chart', 'push-pull-arena', 'ramp-lab', 'rhyme-studio', 'shape-sorter', 'sorting-station', 'sound-swap', 'spatial-scene', 'story-bridge', 'story-ribbon', 'syllable-clapper', 'ten-frame', 'word-builder', 'word-flip', 'word-sorter', 'word-workout',
      'you-and-me']);
