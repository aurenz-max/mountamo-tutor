        ...
        <details className="group/dev">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 mt-4">
            {([
              ...
              { panel: 'direct-instruction-tester', icon: '\uD83D\uDDE3\uFE0F', title: 'DI Letter Sounds', color: '34, 211, 238', cardClass: 'bg-gradient-to-br from-cyan-900/20 to-blue-900/20', iconClass: 'bg-cyan-500/20', hoverTitle: 'group-hover:text-cyan-200', hoverArrow: 'group-hover:text-cyan-400' },
