...
/** Every catalog mode. The adapter publishes this list and the component switches on it. */
export const TEN_FRAME_WORKSPACE_MODES = ['build', 'make_ten', 'subitize', 'decompose', 'build_teen', 'decompose_teen', 'operate'] as const;
