...
// Flatten/enrich moved to flattenManifest.ts (pure, client-safe) so the
// code-built pulse-check manifest can import them without dragging this
// module's server-only Gemini client into a client bundle. Re-exported
// here for back-compat.
export { flattenManifestToLayout, enrichManifestWithLayout } from './flattenManifest';
