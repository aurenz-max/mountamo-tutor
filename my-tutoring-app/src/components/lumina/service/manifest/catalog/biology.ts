...
export const BIOLOGY_CATALOG: ComponentDefinition[] = [
  ...
  {
    id: 'cell-builder',
    description: 'Three-phase interactive cell biology primitive. Phase 1 (Sort): Students classify which organelles belong in this cell type and which are distractors that don\'t belong. Phase 2 (Place + Quantity): Students drag organelles into biological zones (center, peripheral, near-nucleus, membrane-associated, scattered) and answer quantity reasoning questions for specialized cells (e.g., muscle cells need lots of mitochondria). Phase 3 (Match Functions): Students match organelles to function descriptions. Supports specialized cell contexts (muscle cell, nerve cell, leaf cell, root cell) that drive quantity reasoning. Handles animal cells (centrioles, no wall), plant cells (chloroplasts, cell wall, large vacuole), prokaryotic cells (no membrane-bound organelles), and fungal cells (cell wall, no chloroplasts). PERFECT for teaching cell structure, organelle classification, structure-function mapping, and understanding how cell specialization affects organelle composition. ESSENTIAL for grades 4-8 cell biology lessons.',
    constraints: 'Use for grades 4-8 students learning cell structure and organelle functions. Grade 4-5: Simpler vocabulary, 5-7 major organelles plus 2-3 distractors, everyday analogies, simple quantity reasoning. Grade 6-8: Scientific terminology, 7-10 organelles plus 3-4 distractors including ER, Golgi apparatus, lysosomes, ribosomes. Supports specialized cell contexts: "muscle cell" (lots of mitochondria for energy), "nerve cell" (many mitochondria for signal transmission), "leaf cell" (lots of chloroplasts for photosynthesis), "root cell" (many mitochondria for active transport). Perfect for: animal cell structure, plant cell structure, plant vs animal cell comparison, specialized cell types, prokaryotic cells (grades 7-8), organelle function matching, cell biology review.',
    supportsEvaluation: true,
  },
  {
    id: 'inheritance-lab',
