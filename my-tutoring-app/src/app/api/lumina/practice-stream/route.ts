...
export async function POST(request: NextRequest) {
  try {
    ...
    const { topic, gradeLevel, problemCount, enforceDiversity, sessionHistory, targetMode, band, recentPrimitives } = body;
      ...
      try {
        ...
        const manifest = await generatePracticeManifest(
          ...
          },
          {
            ...
            sessionHistory: Array.isArray(sessionHistory) ? sessionHistory : undefined,
            targetMode: typeof targetMode === 'number' ? targetMode : undefined,
            band: typeof band === 'string' ? band : undefined,
