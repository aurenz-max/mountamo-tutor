...
is now scored). **Generic W1 contract test DONE 09-24** (`runtime/workspaceContract.test.tsx`, 21 families, 53 saved payloads). **B2 done 09-24** ([report](../tutor-reports/workspace-rollout-B2-2026-09-24.md)): cvc-speller, phonics-blender, sound-swap, word-flip, workspace only. **Next: batch B3.**
