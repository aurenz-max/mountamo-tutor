...
| `math/BalanceScaleEquality.tsx` | standalone + live + ordinary lessons | **W1 on the workspace 09-23** (batch B1, `useWorkspaceRunner`; the family's plain surfaces too). [Report](../tutor-reports/workspace-rollout-B1-2026-09-23.md) |
| `math/BalanceScaleWorkshop.tsx` | standalone + live + ordinary lessons | **W1 on the workspace 09-23** (batch B1, `useWorkspaceRunner`; the family's plain surfaces too). [Report](../tutor-reports/workspace-rollout-B1-2026-09-23.md) |
| `math/BaseTenBlocksDi.tsx` | standalone + live + ordinary lessons | **W1 on the workspace 09-23** (batch B1, `useWorkspaceRunner`; the family's plain surfaces too). [Report](../tutor-reports/workspace-rollout-B1-2026-09-23.md) |
| `math/BarModelExplanation.tsx` | standalone | **no longer mounts on the workspace path 09-23**: bar-model's two spoken modes bind in the plain `BarModel` with `expectedAnswer` (batch B1). Scripted consumer only. [Report](../tutor-reports/workspace-rollout-B1-2026-09-23.md) |
| `math/FractionTouch.tsx` | standalone + live + ordinary lessons | **W1 on the workspace 09-23** (batch B1, `useWorkspaceRunner`; the family's plain surfaces too). [Report](../tutor-reports/workspace-rollout-B1-2026-09-23.md) |
