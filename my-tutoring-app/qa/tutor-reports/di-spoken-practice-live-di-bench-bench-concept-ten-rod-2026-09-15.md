...
**FAIL** — 2 HIGH + 2 WARN mechanism(s) confirmed (2 + 7 beat instances), 0 single-run note(s).

## Findings

| Status | Severity | Check | Beats (rate) | Example |
|---|---|---|---|---|
| CONFIRMED | HIGH | `di-false-refusal` | probe:bench-concept-ten-rod:valid-paraphrase:it's just the little cubes stuck together 1/1 (1 beat) | CORRECTED a right answer ("it's just the little cubes stuck together"): "My turn: One ten rod is the same as ten ones. If you break the rod apart you get ten little ones, so they are the same amount. Your turn. One ten rod, and ten o" |
...
| CONFIRMED | WARN | `di-silent-turn` | probe:bench-concept-ten-rod:off-task:um 1/1 (1 beat) | no speech in 60s — the loop cannot advance without the tutor's line |
...
**PASS** - zero false affirmations. 14 scored probe(s) over 1 stimulus/stimuli - 11 agreed with the key, 2 missed valid, 1 soft disagreement(s), 1 drew no classifiable verdict.
...
| `bench-concept-ten-rod` | `valid-paraphrase` | it's just the little cubes stuck together | AFFIRM | REFUSE | MISS |
...
*expect: turn · turn_ended: True · 6.0s · audio: 282884 b64 bytes*
...
*expect: turn · turn_ended: True · 5.2s · audio: 252804 b64 bytes*
...
*expect: turn · turn_ended: True · 5.5s · audio: 275204 b64 bytes*
...
*expect: turn · turn_ended: True · 5.1s · audio: 243204 b64 bytes*
...
*expect: turn · turn_ended: True · 5.5s · audio: 268160 b64 bytes*
*note: re-open the same item for the next probe*

> One ten rod, and ten ones. What does the ten rod show us?

### probe:bench-concept-ten-rod:valid-paraphrase:they're both ten
*expect: turn · turn_ended: True · 5.3s · audio: 253440 b64 bytes*
...
*expect: turn · turn_ended: True · 5.4s · audio: 268800 b64 bytes*
*note: re-open the same item for the next probe*

> One ten rod, and ten ones. What does the ten rod show us?

### probe:bench-concept-ten-rod:valid-paraphrase:it's just the little cubes stuck together
*expect: turn · turn_ended: True · 14.7s · audio: 842880 b64 bytes*
...
*expect: turn · turn_ended: True · 5.6s · audio: 273920 b64 bytes*
*note: re-open the same item for the next probe*

> One ten rod, and ten ones. What does the ten rod show us?

### probe:bench-concept-ten-rod:valid-childlike:it's, like, ten of the little ones but in one piece
*expect: turn · turn_ended: True · 5.4s · audio: 248320 b64 bytes*
...
*expect: turn · turn_ended: True · 5.6s · audio: 271364 b64 bytes*
*note: re-open the same item for the next probe*

> One ten rod, and ten ones. What does the ten rod show us?

### probe:bench-concept-ten-rod:valid-partial:same
*expect: turn · turn_ended: True · 15.6s · audio: 885760 b64 bytes*
...
*expect: turn · turn_ended: True · 16.0s · audio: 929284 b64 bytes*
...
*expect: turn · turn_ended: True · 5.7s · audio: 282880 b64 bytes*
...
*expect: turn · turn_ended: True · 15.2s · audio: 885120 b64 bytes*
...
*expect: turn · turn_ended: True · 15.1s · audio: 875520 b64 bytes*
...
*expect: turn · turn_ended: True · 15.5s · audio: 894720 b64 bytes*
...
*expect: turn · turn_ended: True · 15.7s · audio: 899840 b64 bytes*
...
*expect: turn · turn_ended: True · 15.6s · audio: 908804 b64 bytes*
