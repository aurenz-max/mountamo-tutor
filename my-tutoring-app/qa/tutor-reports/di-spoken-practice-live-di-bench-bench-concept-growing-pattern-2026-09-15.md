...
|---|---|---|---|---|
| CONFIRMED | HIGH | `di-no-verdict` | probe:bench-concept-growing-pattern:off-task:um 1/1 (1 beat) | answered "um" and the tutor opened with neither sentinel — the loop stalls here: "Two, four, six, eight. Listen again: two, four, six, eight. What is the rule of this pattern?" |
...
*expect: turn · turn_ended: True · 10.2s · audio: 546560 b64 bytes*
...
*expect: turn · turn_ended: True · 9.8s · audio: 549120 b64 bytes*
...
*expect: turn · turn_ended: True · 9.9s · audio: 547844 b64 bytes*
*note: re-open the same item for the next probe*

> Two, four, six, eight. Listen again: two, four, six, eight. What is the rule of this pattern?

### probe:bench-concept-growing-pattern:valid-paraphrase:every number is two more than the one before
*expect: turn · turn_ended: True · 5.3s · audio: 248324 b64 bytes*
...
*expect: turn · turn_ended: True · 9.8s · audio: 546564 b64 bytes*
*note: re-open the same item for the next probe*

> Two, four, six, eight. Listen again: two, four, six, eight. What is the rule of this pattern?

### probe:bench-concept-growing-pattern:valid-childlike:it's like, two more, two more, two more
*expect: turn · turn_ended: True · 5.3s · audio: 250244 b64 bytes*
...
*expect: turn · turn_ended: True · 9.7s · audio: 536324 b64 bytes*
*note: re-open the same item for the next probe*

> Two, four, six, eight. Listen again: two, four, six, eight. What is the rule of this pattern?

### probe:bench-concept-growing-pattern:valid-partial:twos
*expect: turn · turn_ended: True · 17.9s · audio: 1054720 b64 bytes*
...
*expect: turn · turn_ended: True · 9.7s · audio: 535044 b64 bytes*
*note: re-open the same item for the next probe*

> Two, four, six, eight. Listen again: two, four, six, eight. What is the rule of this pattern?

### probe:bench-concept-growing-pattern:echo:two four six eight
*expect: turn · turn_ended: True · 18.0s · audio: 1049600 b64 bytes*
...
*expect: turn · turn_ended: True · 18.5s · audio: 1093120 b64 bytes*
...
*expect: turn · turn_ended: True · 10.7s · audio: 590084 b64 bytes*
...
*expect: turn · turn_ended: True · 18.1s · audio: 1066240 b64 bytes*
...
*expect: turn · turn_ended: True · 17.9s · audio: 1060480 b64 bytes*
...
*expect: turn · turn_ended: True · 9.9s · audio: 551680 b64 bytes*
*note: re-open the same item for the next probe (correction cap reached)*

> Two, four, six, eight. Listen again: two, four, six, eight. What is the rule of this pattern?

### probe:bench-concept-growing-pattern:negated-keyword:it's not plus two, it's plus one
*expect: turn · turn_ended: True · 18.0s · audio: 1061760 b64 bytes*
...
*expect: turn · turn_ended: True · 17.7s · audio: 1052160 b64 bytes*
...
*expect: turn · turn_ended: True · 9.7s · audio: 537604 b64 bytes*
*note: re-open the same item for the next probe (correction cap reached)*

> Two, four, six, eight. Listen again: two, four, six, eight. What is the rule of this pattern?

### probe:bench-concept-growing-pattern:off-task:I don't know
*expect: turn · turn_ended: True · 18.2s · audio: 1065600 b64 bytes*
...
*expect: turn · turn_ended: True · 9.9s · audio: 536320 b64 bytes*
