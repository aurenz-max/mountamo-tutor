...
**Affected:** hundreds-chart (HC-1, HC-2, HC-3 — all resolved 2026-05-19 via schema removal of `instruction` field); compare-objects (CO-5 — resolved 2026-05-24 via same schema-simplify pattern on the `order_three` mode)
