...
description: >-
  Run a bidirectional audit between curriculum coverage and Lumina primitives. Use when finding underused primitives, curriculum gaps, missing primitive capabilities, or coordinating the curriculum-to-Lumina remediation loop.
---
