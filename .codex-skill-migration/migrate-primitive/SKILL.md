...
description: >-
  Migrate an existing Lumina primitive to the shared Lumina UI kit. Use when replacing hand-written glass styling or raw component chrome with Lumina UI components while preserving behavior.
---
