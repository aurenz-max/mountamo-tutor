...
description: >-
  Audit and densify Lumina primitive evaluation-mode difficulty ladders. Use when calibrating beta spacing, closing large adjacent-mode gaps, or revising mode ordering with the lightest-touch-first approach.
---
