...
name: eval-test
description: >-
  Run focused QA on generated Lumina primitive data and its component contract. Use when validating a primitive, evaluation mode, difficulty tier, generated payload, or lifecycle gate and reporting only confirmed failures.
---
