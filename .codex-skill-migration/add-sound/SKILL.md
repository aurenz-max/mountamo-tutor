...
name: add-sound
description: >-
  Add procedural Web Audio feedback to an existing Lumina primitive using SoundManager. Use when wiring tap, selection, drag-and-drop, stepper, success, or retry sounds without audio asset files.
---
