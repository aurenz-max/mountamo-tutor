...
description: >-
  Add and verify an AI tutoring scaffold for a Lumina primitive. Use when wiring catalog tutoring metadata, contextual hints, struggle responses, pedagogical moments, and live tutor integration.
---
