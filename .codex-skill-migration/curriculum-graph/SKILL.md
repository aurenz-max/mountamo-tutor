...
description: >-
  Diagnose and improve the curriculum knowledge graph for adaptive learning and Pulse diversity. Use when analyzing graph health, simulating candidate pools, generating edge suggestions, or inspecting prerequisite structure.
---
