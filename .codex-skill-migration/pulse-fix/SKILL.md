...
name: pulse-fix
description: >-
  Fix findings produced by the Pulse Agent with a structured root-cause workflow. Use when investigating adaptive engine bugs, incorrect mastery behavior, selection failures, or synthetic-journey report findings.
---
