...
name: eval-fix
description: >-
  Fix issues reported by Lumina eval-test using a structured root-cause workflow. Use when a primitive has generator-to-component contract failures, broken evaluation modes, invalid content, or runtime QA findings.
---
