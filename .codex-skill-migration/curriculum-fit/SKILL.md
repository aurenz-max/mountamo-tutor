...
name: curriculum-fit
description: >-
  Test whether a Lumina primitive has an honest curriculum home using scoped embedding retrieval. Use when auditing primitive-to-curriculum attribution, investigating retrieval misses, or checking grade-specific catalog fit without auto-editing.
---
