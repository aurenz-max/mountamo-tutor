...
name: primitive
description: >-
  Design and implement a new Lumina primitive end to end. Use when adding a new interactive learning component, including its data contract, generator, catalogs, registry wiring, evaluation, tutoring, and runtime validation.
---
