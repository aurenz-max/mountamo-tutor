...
description: >-
  Add voice-based answering or selection to an existing Lumina primitive. Use when consuming Lumina voice capture hooks, mapping recognized speech to existing UI state, and preserving tap or click fallback.
---
