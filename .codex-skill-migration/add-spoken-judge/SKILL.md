...
---
name: add-spoken-judge
description: >-
  Add spoken-production judging to a Lumina literacy primitive. Use when implementing push-to-talk word production, Azure-to-Gemini judge fallback, asymmetric spoken grading, and voice tutor coaching.
---
